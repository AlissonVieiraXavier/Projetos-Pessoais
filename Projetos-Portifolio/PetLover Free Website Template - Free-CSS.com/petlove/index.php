        ...
        <div class="row">
            <div class="col-md-6 text-center text-md-left mb-3 mb-md-0">
                <p class="m-0 text-white">
                    &copy; <a class="text-white font-weight-bold" href="#">Site Name</a>. All Rights Reserved. Designed by
                    <a class="text-white font-weight-bold" target="_blank"href="https://www.linkedin.com/in/alisson-xavier-339677173/">Alisson Xavier</a>
                </p>
            </div>
